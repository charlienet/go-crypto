...
func GenerateKeyPair(algorithm AsymmetricAlgorithm, opts ...KeyGenOption) (*KeyPair, error) {
	...
	default:
		return nil, fmt.Errorf("no engine registered for %s; add blank import: _ \"github.com/charlienet/go-crypto/crypto/keymgr\" or _ \"github.com/charlienet/go-crypto/crypto/engines\" for all: %w", algorithm, ErrEngineNotRegistered)
	}
}
