...
func NewAsymmetric(algorithm AsymmetricAlgorithm, opts ...AsymOption) (Asymmetric, error) {
	...
	default:
		return nil, fmt.Errorf("no engine registered for %s; add blank import: _ \"github.com/charlienet/go-crypto/crypto/asym\" or _ \"github.com/charlienet/go-crypto/crypto/engines\" for all: %w", algorithm, ErrEngineNotRegistered)
	}
}
